...
export const Profile = () => {
    ...
    const [updateEmail, updatingEmail, errorUpdateEmail] = useUpdateEmail(
        auth.getAuth()
    );
    const [updatePassword, updatingPassword, errorUpdatePassword] =
        useUpdatePassword(auth.getAuth());
    const [updateProfile, updatingProfile, errorProfile] = useUpdateProfile(
        auth.getAuth()
    );
