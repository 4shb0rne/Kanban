...
import { closeBoard } from "../../controller/BoardController";
const BoardList = ({
    logOut,
    boards,
    addNewBoard,
        ...
        <div className=" h-screen px-6 py-4 sm:py-20 sm:px-24">
            <div className="flex flex-col my-2">
                <div className="flex justify-between">
                    ...
                    <div>
                        <button
                            className="inline-block px-6 py-2.5 m-3 bg-red-400 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-red-700 hover:shadow-lg focus:bg-red-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-red-800 active:shadow-lg transition duration-150 ease-in-out"
                            onClick={() => {
                                setClosedModal(true);
                            }}
                        >
                ...
                <div className="my-12">
                    ...
                    <div className="flex flex-wrap mt-2">
                        ...
                        <Modal
                            modal={closedModal}
                            setModal={setClosedModal}
                            ariaText="Closed Boards"
                        >
                            <ClosedBoards
                                workspaceId={workspaceId}
                            ></ClosedBoards>
